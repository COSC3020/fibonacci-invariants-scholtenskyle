...
The Invariant is as follows: When summing the previous 2 values in the sequence, assume they are correct. We know that the first 2 will be correct, since they are set to be specific value on initialization. From there, we can guarantee the previous values are always correct, which is very important in a sequence such as this, that builds on the previous values.
